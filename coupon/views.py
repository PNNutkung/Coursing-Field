...
from mainmodels.models import Coupon
...
def add_coupon(req):
    ...
    try:
        ...
        return render(req, 'coupon/add_coupon.html', { 'message': 'Create a new coupon successfully.', 'serial': coupon_serial })#success, do something
