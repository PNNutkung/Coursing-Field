"""
Django settings for coursing_field project.
...
SECRET_KEY = 'drjjnrpy0sx_$9x7wwt1u3fya=w8jc4=k!*dq)+71y44k_nzc@'
...
ROOT_URLCONF = 'coursing_field.urls'
...
WSGI_APPLICATION = 'coursing_field.wsgi.application'
