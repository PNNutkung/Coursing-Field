...
def view_course(req, courseID):
    if req.user.is_authenticated:
        ...
        return render(req, 'course/viewCourse.html', {'course' : course, 'hasTakenCourse' : hasTakencourse, 'isOwner' : isOwner, 'inCategory' : inCategory, 'userWithProfile' : userWithProfile})
    else:
